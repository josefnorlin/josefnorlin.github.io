...
class Player {
  ...
  shoot(mouse, color = 'white') {
    ...
    playAudio ? shootAudio.cloneNode().play() : ''
  }
}
...
function animate() {
  ...
  powerUps.forEach((powerUp, index) => {
    ...
    if (dist - player.radius - powerUp.width / 2 < 1) {
      ...
      playAudio ? obtainPowerUpAudio.cloneNode().play() : ''
    ...
    projectiles.forEach((projectile, projectileIndex) => {
      ...
      if (dist - enemy.radius - projectile.radius < 0.03) {
        ...
        if (enemy.radius - 10 > 5) {
          playAudio ? enemyHitAudio.cloneNode().play() : '';
          ...
          // eliminate enemy
          playAudio ? enemyEliminatedAudio.cloneNode().play() : ''
